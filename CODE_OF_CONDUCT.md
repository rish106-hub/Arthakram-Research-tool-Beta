...
We as members, contributors, and maintainers of **Arthakram Research Tool** pledge to make participation in our project and community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
- Publishing others' private information (doxxing), such as a physical or electronic address, without explicit permission
...
This Code of Conduct applies within all project spaces — including GitHub Issues, Pull Requests, Discussions, code comments, and any other communication channel used by the project — and also applies when an individual is officially representing the project in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported by opening a GitHub Issue (mark it `[CoC]`) or by tagging the maintainer `@rish106-hub` in a comment. All complaints will be reviewed and investigated promptly and fairly.
